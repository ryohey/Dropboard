...
$(function() {
  ...
  return $(window).keydown(function(e) {
    if (e.ctrlKey && e.keyCode === 13) {
      if ($("#contextMenu").is(':visible')) $("#contextMenu .ok").click();
    }
    if (e.keyCode === 27) return $("#contextMenu").hide();
  });
});
