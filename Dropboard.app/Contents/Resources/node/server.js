...
var DATA_PATH, PUBLIC_PATH, UPLOAD_PATH, app, checkPort, dir, dirs, express, fs, getFiles, isSet, os, port, request, shorten, sortByDate, url, _i, _len;
...
io.sockets.on('connection',   function (socket) {
   ...
   * 監視を開始する.
   */
  var watcher = fs.watch(DATA_PATH,  function(event,  filename){
    /*
